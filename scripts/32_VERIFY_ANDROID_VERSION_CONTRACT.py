...
def main()->int:
 p=argparse.ArgumentParser(); p.add_argument('--phase',required=True); p.add_argument('--version',default='AUTO'); p.add_argument('--print-version',action='store_true'); p.add_argument('--print-upgrade-from',action='store_true'); a=p.parse_args()
 ...
 if a.print_upgrade_from:
  print(row.get('upgrade_test_from') or 'NONE'); return 0
