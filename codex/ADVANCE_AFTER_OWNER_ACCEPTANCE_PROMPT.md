...
3. 运行 `.\ylven.ps1 close-release -Phase <当前阶段>`。控制器必须先校验线上服务器构建来源、精确 Commit、版本、下载 SHA-256 和物理真机验收证据，创建/校验不可变 Tag，追加 `RELEASE_LEDGER.jsonl`，提交状态并推进到相邻阶段第一个 Work Packet。
