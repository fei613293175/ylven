...
export default {
  setup() {
    ...
    const actionLabel = computed(() => path.value === '/admin/037' ? '新增角色' : path.value === '/admin/040' ? '编辑模板' : path.value === '/admin/039' ? '安全确认' : ['/admin/026','/admin/034','/admin/035','/admin/p03-home'].includes(path.value) ? '编辑配置' : '')
