...
- [x] T028 `[P00-021..P00-024]` Run provider, secret, Web, RBAC, browser screenshot, visual-diff, and safety tests; finalize evidence, commit cleanly, and close only `P00-W05` through the controller.
